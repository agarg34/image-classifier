...
class SimpleConvNet(nn.Module):
    ...
    def __init__(self, input_shape=(32, 32), num_classes=100):
        ...
        layers = []
        # 2 convs
        layers.append(nn.Conv2d(3, 32, kernel_size=3, stride=1))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.BatchNorm2d(32))

        layers.append(nn.Conv2d(32, 32, kernel_size=3, stride=1))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.BatchNorm2d(32))
        ...
        layers.append(nn.Conv2d(32, 100, kernel_size=3, stride=2))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.BatchNorm2d(100))

        layers.append(nn.Conv2d(100, 100, kernel_size=2, stride=1))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.BatchNorm2d(100))
        ...
        layers.append(nn.Linear(400, 256))
        layers.append(nn.ReLU(inplace=True))
